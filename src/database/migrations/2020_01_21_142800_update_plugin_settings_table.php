...
class UpdatePluginSettingsTable extends Migration
{
    ...
    public function up()
    {
        $setting_data = [
            ...
            'enabled'         => 1,
            'sort_value'      => 20,
            'abstract'        => 'Semi-finished plugin for your own use. Add your Laravel controller into the CMS. <a href="https://github.com/AlexStack/Laravel-CMS-Plugin-MyPlugin001" target="_blank"><i class="fas fa-link mr-1"></i>Tutorial</a>',
            'param_value'     => '{
